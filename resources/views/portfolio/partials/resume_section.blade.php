<section id="resume" class="resume section">
    <div class="container section-title text-center" data-aos="fade-up">
        ...
        <a href="{{ asset('assets/docs/cv_laravel_en.pdf') }}" target="_blank"
            class="btn btn-primary btn-lg rounded-pill px-4 py-2 mt-3 shadow-sm">
                ...
                <div class="professional-journey">
                    ...
                    <div class="experience-timeline">
                        <div class="timeline-item pb-4 border-start border-primary border-2 ps-4 position-relative">
                            ...
                            <p class="text-white small">Full-Stack Development (Laravel & Livewire), POS Systems & Web
                                Applications.</p>
                        </div>

                        <div class="timeline-item pb-4 border-start border-primary border-2 ps-4 position-relative">
                            <div class="position-absolute top-0 start-0 translate-middle bg-secondary rounded-circle"
                                style="width: 15px; height: 15px;"></div>
                    ...
                    <div class="row g-3">
                        <div class="col-md-12">
                            <div class="p-3 border rounded shadow-sm bg-dark text-white">
                                ...
                                <h6 class="fw-bold"><i class="bi bi-braces fs-4 text-primary "></i> Backend & Database
                                </h6>
                        ...
                        <div class="col-md-12">
                            <div class="p-3 border rounded shadow-sm bg-dark text-white">
                                ...
                                <h6 class="fw-bold"><i class="bi bi-window-sidebar fs-4 text-primary "></i> Frontend
                                </h6>
                        ...
                        <div class="col-md-12">
                            <div class="p-3 border rounded shadow-sm bg-dark text-white">
                                ...
                                <h6 class="fw-bold"><i class="bi bi-briefcase fs-4 text-primary "></i> Business Logic
                                </h6>
